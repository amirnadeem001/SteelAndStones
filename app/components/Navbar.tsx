...
export function Navbar() {
  ...
  return (
    <>
          ...
          <div className="hidden items-center gap-6 lg:flex">
            <div className="flex items-center gap-3 text-white">
              ...
              <div>
                ...
                <p className="text-sm font-bold">+92 302 0007964s</p>
              </div>
            </div>
      ...
      <div 
        className={cn(
          "fixed inset-0 z-[100] bg-[#111111] transition-all duration-500 lg:hidden",
          mobileMenuOpen ? "opacity-100 pointer-events-auto visible" : "opacity-0 pointer-events-none invisible"
        )}
      >
        <div className="relative flex flex-col h-full w-full p-8 pt-32 overflow-y-auto no-scrollbar">
          {/* Close button */}
          <button 
            className="absolute top-10 right-8 text-white p-2"
          ...
          <div className="flex flex-col gap-8">
            {navLinks.map((link) => (
              <Link 
                ...
                onClick={() => setMobileMenuOpen(false)}
                className={cn(
                  "text-4xl font-bold uppercase tracking-[0.1em] flex justify-between items-center border-b border-white/5 pb-6",
            ...
            <div className="mt-12 flex flex-col gap-10">
              <div className="flex items-center gap-5 text-white">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold">+92 302 0007964</p>
                </div>
              </div>
              <Link 
                href="/contact" 
                onClick={() => setMobileMenuOpen(false)}
                className="w-full text-center rounded-full bg-[#c5a47e] py-7 text-xs font-black uppercase tracking-[0.3em] text-zinc-900 shadow-xl"
              >
                Get A Quote!
              </Link>
            </div>
